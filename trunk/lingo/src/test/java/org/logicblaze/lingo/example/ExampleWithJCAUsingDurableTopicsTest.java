 ...
 * @version $Revision$
 */
public class ExampleWithJCAUsingDurableTopicsTest extends ExampleWithJCAUsingTopicsTest {

    protected String getApplicationContextXml() {
        return "org/logicblaze/lingo/example/spring-with-jca-durable-topics.xml";
    }
}
